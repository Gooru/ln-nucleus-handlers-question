...
public class AJRubricRepo implements RubricRepo {
  ...
  public MessageResponse updateRubric() {
    return TransactionExecutor
        .executeTransaction(DBHandlerBuilder.buildUpdateRubricHandler(context));
  }

  @Override
  public MessageResponse fetchRubric() {
    return TransactionExecutor
        .executeTransaction(DBHandlerBuilder.buildFetchRubricHandler(context));
  }

  @Override
  public MessageResponse createRubric() {
    return TransactionExecutor
        .executeTransaction(DBHandlerBuilder.buildCreateRubricHandler(context));
  }

  @Override
  public MessageResponse deleteRubric() {
    return TransactionExecutor
        .executeTransaction(DBHandlerBuilder.buildDeleteRubricHandler(context));
  }
