...
public class AJEntityQuestion extends Model {
  ...
  public static final List<String> FETCH_QUESTION_FIELDS = Arrays
      .asList(ID, TITLE, PUBLISH_DATE, DESCRIPTION, ANSWER, METADATA, TAXONOMY,
          HINT_EXPLANATION_DETAIL, THUMBNAIL,
          NARRATION, LICENSE, CREATOR_ID, CONTENT_SUBFORMAT, VISIBLE_ON_PROFILE, COURSE_ID, UNIT_ID,
          LESSON_ID,
  ...
  private static final List<String> INSERT_QUESTION_ALLOWED_FIELDS = Arrays
      .asList(TITLE, DESCRIPTION, CONTENT_SUBFORMAT, ANSWER, METADATA, TAXONOMY, NARRATION,
  ...
  private static final List<String> UPDATE_QUESTION_ALLOWED_FIELDS = Arrays
      .asList(TITLE, DESCRIPTION, ANSWER, METADATA, TAXONOMY, HINT_EXPLANATION_DETAIL, THUMBNAIL,
          VISIBLE_ON_PROFILE,
          NARRATION, PRIMARY_LANGUAGE, MAX_SCORE);

  public static final List<String> INSERT_QUESTION_FORBIDDEN_FIELDS = Arrays
      .asList(ID, URL, CREATED_AT, UPDATED_AT, CREATOR_ID, MODIFIER_ID, ORIGINAL_CREATOR_ID,
          ORIGINAL_CONTENT_ID,
          PUBLISH_DATE, CONTENT_FORMAT, COURSE_ID, UNIT_ID, LESSON_ID, COLLECTION_ID, SEQUENCE_ID,
          IS_COPYRIGHT_OWNER,
  ...
  public static final List<String> QUESTION_TYPES = Arrays
      .asList("multiple_choice_question", "multiple_answer_question", "true_false_question",
          ...
          "hot_text_highlight_question", "hot_spot_image_question", "hot_spot_text_question",
          "external_question");

  public static final List<String> RUBRIC_ASSOCIATION_ALLOWED_TYPES = Arrays
      .asList("open_ended_question");
  ...
  public void setMaxScore(Integer newMaxScore) {
    setFieldUsingConverter(MAX_SCORE, newMaxScore);
  }
