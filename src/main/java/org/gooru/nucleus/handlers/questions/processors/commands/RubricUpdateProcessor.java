 ...
 */
public class RubricUpdateProcessor extends AbstractCommandProcessor {

  protected RubricUpdateProcessor(ProcessorContext context) {
    super(context);
  }
  ...
  protected MessageResponse processCommand() {
    ...
    return RepoBuilder.buildRubricRepo(context).updateRubric();
  }
