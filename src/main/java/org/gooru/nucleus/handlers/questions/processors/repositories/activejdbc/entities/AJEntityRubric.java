...
public class AJEntityRubric extends Model {
  ...
  public static final List<String> RUBRIC_SUMMARY =
      Arrays.asList(ID, TITLE, URL, IS_REMOTE, DESCRIPTION, CATEGORIES, FEEDBACK_GUIDANCE,
          OVERALL_FEEDBACK_REQUIRED,
          CREATOR_ID, MODIFIER_ID, ORIGINAL_CREATOR_ID, ORIGINAL_RUBRIC_ID, PARENT_RUBRIC_ID,
          PUBLISH_STATUS, GUT_CODES,
          METADATA, TAXONOMY, THUMBNAIL, CREATED_AT, UPDATED_AT, TENANT, VISIBLE_ON_PROFILE,
          INCREMENT,
          COURSE_ID, UNIT_ID, LESSON_ID, COLLECTION_ID, CONTENT_ID, IS_RUBRIC, SCORING, MAX_SCORE,
          GRADER, PRIMARY_LANGUAGE);
  ...
  private static final List<String> INSERT_RUBRIC_ON_MANDATORY_FIELDS = Arrays
      .asList(TITLE, IS_RUBRIC);

  private static final List<String> INSERT_RUBRIC_ON_ALLOWED_FIELDS = Arrays
      .asList(TITLE, DESCRIPTION, METADATA,
  ...
  private static final List<String> UPDATE_RUBRIC_ALLOWED_FIELDS =
      Arrays.asList(TITLE, DESCRIPTION, METADATA, TAXONOMY, THUMBNAIL, URL, IS_REMOTE,
          FEEDBACK_GUIDANCE, SCORING,
  ...
  public static final List<String> FETCH_RUBRIC_ON_FIELDS =
      Arrays.asList(ID, TITLE, URL, IS_REMOTE, DESCRIPTION, IS_RUBRIC, GRADER, CATEGORIES,
          FEEDBACK_GUIDANCE,
          OVERALL_FEEDBACK_REQUIRED, CREATOR_ID, MODIFIER_ID, ORIGINAL_CREATOR_ID,
          ORIGINAL_RUBRIC_ID, GUT_CODES,
  ...
  private static final List<String> INSERT_RUBRIC_OFF_ALLOWED_FIELDS =
      Arrays.asList(IS_RUBRIC, OVERALL_FEEDBACK_REQUIRED, FEEDBACK_GUIDANCE, SCORING, MAX_SCORE,
          INCREMENT, GRADER, PRIMARY_LANGUAGE);

  private static final List<String> ASSOCIATE_ALLOWED_FIELDS =
      Arrays.asList(COURSE_ID, UNIT_ID, LESSON_ID, COLLECTION_ID);

  public static final List<String> FETCH_RUBRIC_OFF_FIELDS = Arrays
      .asList(ID, IS_RUBRIC, COURSE_ID, UNIT_ID,
          LESSON_ID, COLLECTION_ID, CONTENT_ID, SCORING, MAX_SCORE, INCREMENT, GRADER,
          FEEDBACK_GUIDANCE,
          OVERALL_FEEDBACK_REQUIRED, CREATOR_ID, MODIFIER_ID, CREATED_AT, UPDATED_AT, TENANT,
          TENANT_ROOT, PRIMARY_LANGUAGE);
  ...
  public static final List<String> INSERT_RUBRIC_FORBIDDEN_FIELDS =
      Arrays.asList(ID, URL, IS_REMOTE, CATEGORIES, CREATED_AT, UPDATED_AT, CREATOR_ID, MODIFIER_ID,
          ORIGINAL_CREATOR_ID, ORIGINAL_RUBRIC_ID, PARENT_RUBRIC_ID, COURSE_ID, UNIT_ID, LESSON_ID,
          COLLECTION_ID,
  ...
  private static final List<String> SCORING_ALLOWED_FIELDS = Arrays
      .asList(SCORING, MAX_SCORE, INCREMENT);
  public static final List<String> SCORING_FIELDS = Arrays
      .asList(ID, SCORING, MAX_SCORE, INCREMENT, IS_RUBRIC);
  ...
  private static Map<String, FieldConverter> initializeConverters() {
    ...
    converterMap.put(GUT_CODES,
        (fieldValue -> FieldConverter.convertFieldToTextArray((String) fieldValue)));
    converterMap.put(TAXONOMY, (FieldConverter::convertFieldToJson));
    converterMap.put(CATEGORIES, (FieldConverter::convertFieldToJson));
    ...
    converterMap
        .put(UNIT_ID, (fieldValue -> FieldConverter.convertFieldToUuid((String) fieldValue)));
    converterMap
        .put(LESSON_ID, (fieldValue -> FieldConverter.convertFieldToUuid((String) fieldValue)));
    converterMap
        .put(COLLECTION_ID, (fieldValue -> FieldConverter.convertFieldToUuid((String) fieldValue)));
    converterMap
  ...
  private static Map<String, FieldValidator> initializeValidators() {
    ...
    validatorMap
        .put(DESCRIPTION, (value) -> FieldValidator.validateStringAllowNullOrEmpty(value, 20000));
    ...
    validatorMap
        .put(THUMBNAIL, (value) -> FieldValidator.validateStringAllowNullOrEmpty(value, 2000));
    ...
    validatorMap.put(FEEDBACK_GUIDANCE,
        (value) -> FieldValidator.validateStringAllowNullOrEmpty(value, 5000));
