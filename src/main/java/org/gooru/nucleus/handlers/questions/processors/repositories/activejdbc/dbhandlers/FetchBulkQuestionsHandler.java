...
public class FetchBulkQuestionsHandler implements DBHandler {
  ...
  public ExecutionResult<MessageResponse> checkSanity() {
    ...
    if (questionIdList.size() > 50) {
      ...
      return new ExecutionResult<>(
          MessageResponseFactory
              .createInvalidRequestResponse(RESOURCE_BUNDLE.getString("max.question.ids")),
          ExecutionResult.ExecutionStatus.FAILED);
    }
    ...
    for (String questionId : questionIdList) {
      try {
        ...
        return new ExecutionResult<>(MessageResponseFactory.createInvalidRequestResponse(
            RESOURCE_BUNDLE.getString("invalid.question.id")),
            ExecutionResult.ExecutionStatus.FAILED);
      }
    }
  ...
  public ExecutionResult<MessageResponse> validateRequest() {
    this.questions = AJEntityQuestion
        .findBySQL(AJEntityQuestion.FETCH_QUESTIONS_BULK, AJEntityQuestion.QUESTION,
