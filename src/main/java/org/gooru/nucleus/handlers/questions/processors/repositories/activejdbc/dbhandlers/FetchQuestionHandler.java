...
class FetchQuestionHandler implements DBHandler {
  ...
  public ExecutionResult<MessageResponse> validateRequest() {
    ...
    LazyList<AJEntityQuestion> questions = AJEntityQuestion
        .findBySQL(AJEntityQuestion.FETCH_QUESTION, AJEntityQuestion.QUESTION, context.questionId(),
            false);
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    JsonObject response = new JsonObject(JsonFormatterBuilder
        .buildSimpleJsonFormatter(false, AJEntityQuestion.FETCH_QUESTION_FIELDS)
        .toJson(this.question));
