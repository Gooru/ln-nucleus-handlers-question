 ...
 */
public class RubricDeleteProcessor extends AbstractCommandProcessor {

  protected RubricDeleteProcessor(ProcessorContext context) {
    super(context);
  }
  ...
  protected MessageResponse processCommand() {
    ...
    return RepoBuilder.buildRubricRepo(context).deleteRubric();
  }
