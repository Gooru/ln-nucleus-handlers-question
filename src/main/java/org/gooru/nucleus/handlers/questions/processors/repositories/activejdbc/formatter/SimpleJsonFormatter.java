package org.gooru.nucleus.handlers.questions.processors.repositories.activejdbc.formatter;
 ...
 * and just assumes that formatter is needed to work on the entity provided. The difference with AJ
 * provided Model.toJson() is difference in handling of "jsonb" field type in postgres
 */
